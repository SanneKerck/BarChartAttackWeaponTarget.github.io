...
// Get the Data
d3.csv("https://gist.githubusercontent.com/SanneKerck/3917b82dabb564399cd796d94aac8599/raw/f7f5400c2bf5fb43b4178fbee223ae7951215c2e/HistAttackWeaponTarget.csv", function(data) { 
//d3.csv("HistAttackWeaponTarget.csv", function(data) {    
    ...
    svg.append("text")
        ...
        .text("Bar chart of the number of attacks by year and weapon type by target type");
    ...
    svg.append("g")
        ...
        .on("mousemove", function(d) {
            console.log(d);
            tooltip.select("text").html("The exact number of attacks with this target type is: " + (d[1]-d[0]));
        });
